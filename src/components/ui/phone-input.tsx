 ...
 * Prevents decimal places and ensures digits only
 */
...
// Country codes in specified order: +1, +61, +65, +84, +91
const COUNTRY_CODES = [
  { code: "+1" },
  { code: "+61" },
  { code: "+65" },
...
export const PhoneInput = React.forwardRef<HTMLInputElement, PhoneInputProps>(
  (
    ...
    React.useEffect(() => {
      if (value) {
        ...
        if (matchedCode) {
          ...
          // Extract phone number part (digits only)
    ...
    // Handle phone number change - remove any non-digit characters (including decimals)
